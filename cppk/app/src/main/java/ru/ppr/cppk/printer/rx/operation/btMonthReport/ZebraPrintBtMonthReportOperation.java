 ...
 */
public class ZebraPrintBtMonthReportOperation extends PrinterBaseOperation implements PrintBtMonthReportOperation {

    private static final String TAG = Logger.makeLogTag(ZebraPrintBtMonthReportOperation.class);

    private final BtMonthReportTpl.Params params;
    private final TextFormatter textFormatter;

    public ZebraPrintBtMonthReportOperation(IPrinter printer, TextFormatter textFormatter, BtMonthReportTpl.Params params, PrinterResourcesManager printerResourcesManager) {
