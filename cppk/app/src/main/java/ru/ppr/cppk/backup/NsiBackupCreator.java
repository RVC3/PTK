...
/**
 * Создаёт резервную копию базы НСИ.
 * Использует новый механизм создания, с шаблонами.
 *
 * @author Grigorii Kashka
 */
public class NsiBackupCreator extends DbBackupCreatorImpl {

    private static final String BACKUP_TYPE = "nsi";

    private final BackupTemplateCreator backupTemplateCreator;

    @Inject
    NsiBackupCreator(FilePathProvider filePathProvider,
    ...
    public File provideTemplate() throws InterruptedException, ExecutionException, NoSuchAlgorithmException, IOException {
        return backupTemplateCreator.provideNsiDbTemplate();
    }
