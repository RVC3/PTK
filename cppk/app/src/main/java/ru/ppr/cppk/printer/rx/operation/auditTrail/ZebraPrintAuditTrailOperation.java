 ...
 */
public class ZebraPrintAuditTrailOperation extends PrinterBaseOperation implements PrintAuditTrailOperation {

    private static final String TAG = Logger.makeLogTag(ZebraPrintAuditTrailOperation.class);

    private final AuditTrailTpl.Params params;
    private final TextFormatter textFormatter;

    public ZebraPrintAuditTrailOperation(IPrinter printer, TextFormatter textFormatter, AuditTrailTpl.Params params, PrinterResourcesManager printerResourcesManager) {
