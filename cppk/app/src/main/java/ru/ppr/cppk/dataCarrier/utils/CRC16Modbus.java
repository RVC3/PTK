package ru.ppr.cppk.dataCarrier.utils;

import java.util.zip.Checksum;

/**
 * Класс, выполниющий подсчет CRC.
 * <p>
 * Created by Кашка Григорий on 01.02.2016.
 * <p>
 * User: punksa
 * Date: 13-10-11
 * Time: 下午10:33
...
public class CRC16Modbus implements Checksum {
    ...
    public static byte[] getCrc(byte[] data) {
        ...
        byteStr[1] = (byte) ((crc.getValue() & 0x000000ff));
        byteStr[0] = (byte) ((crc.getValue() & 0x0000ff00) >>> 8);

        System.out.printf("%02X%02X%n", byteStr[0], byteStr[1]);
        System.out.printf("%02d%n%02d%n", byteStr[0], byteStr[1]);
