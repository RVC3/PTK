...
/**
 * Создаёт резервную копию базы Security.
 * Использует новый механизм создания, с шаблонами.
 *
 * @author Grigorii Kashka
 */
public class SecurityBackupCreator extends DbBackupCreatorImpl {

    private static final String BACKUP_TYPE = "security";

    private final BackupTemplateCreator backupTemplateCreator;

    @Inject
    SecurityBackupCreator(BackupArchiveCreator backupArchiveCreator,
    ...
    public File provideTemplate() throws InterruptedException, ExecutionException, NoSuchAlgorithmException, IOException {
        return backupTemplateCreator.provideSecurityDbTemplate();
    }
