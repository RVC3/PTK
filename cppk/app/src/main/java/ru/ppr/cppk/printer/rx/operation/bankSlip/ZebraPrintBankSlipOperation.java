 ...
 */
public class ZebraPrintBankSlipOperation extends PrinterPrintBankSlipOperation {

    private static final String TAG = Logger.makeLogTag(ZebraPrintBankSlipOperation.class);

    public ZebraPrintBankSlipOperation(IPrinter printer, PrinterPrintBankSlipOperation.Params params, TextFormatter textFormatter, PrinterResourcesManager printerResourcesManager) {
