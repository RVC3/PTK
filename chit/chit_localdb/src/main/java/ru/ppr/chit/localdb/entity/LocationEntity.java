 ...
 */
@Entity(nameInDb = LocationEntity.TABLE_NAME)
public class LocationEntity implements LocalEntityWithId<Long> {
    ...
    @Generated(hash = 1111779249)
    public LocationEntity(Long id, String carNumber, String placeNumber) {
        this.id = id;
