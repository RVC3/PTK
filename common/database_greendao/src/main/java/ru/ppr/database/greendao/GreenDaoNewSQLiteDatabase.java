 ...
 */
public class GreenDaoNewSQLiteDatabase implements GreenDaoDatabase {

    private final SQLiteDatabase delegate;
    private TransactionListener transactionListener;

    GreenDaoNewSQLiteDatabase(SQLiteDatabase delegate) {
    ...
    @Override
    public GreenDaoNewSQLiteDatabaseStatement compileStatement(String sql) {
        return new GreenDaoNewSQLiteDatabaseStatement(delegate.compileStatement(sql));
    }
