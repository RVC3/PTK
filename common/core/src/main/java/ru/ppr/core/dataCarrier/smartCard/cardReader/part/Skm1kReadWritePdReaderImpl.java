...
/**
 * Ридер ПД и ЭЦП для СКМ 1k.
 *
 * @author Grigoriy Kashka
 */
public class Skm1kReadWritePdReaderImpl extends BaseClassicCardReader implements Skm1kReadWritePdReader {
    ...
    public Skm1kReadWritePdReaderImpl(IRfid rfid,
                                      CardInfo cardInfo,
