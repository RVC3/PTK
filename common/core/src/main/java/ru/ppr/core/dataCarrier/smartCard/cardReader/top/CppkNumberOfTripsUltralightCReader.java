...
/**
 * Ридер карт ЦППК Ultralight C на количество поездок (1 ПД на карту).
 *
 * @author Aleksandr Brazhkin
 */
public class CppkNumberOfTripsUltralightCReader extends BaseCppkNumberOfTripsOnePdReader implements CppkNumberOfTripsOnePdReader {

    private static final byte EDS_PAGE_NUMBER = 20;
    private static final byte EDS_BYTE_NUMBER = 0;
    private static final byte EDS_LENGTH = 64;

    private static final byte PASSAGE_MARK_PAGE = 36;
    ...
    public CppkNumberOfTripsUltralightCReader(IRfid rfid,
                                              CardInfo cardInfo,
