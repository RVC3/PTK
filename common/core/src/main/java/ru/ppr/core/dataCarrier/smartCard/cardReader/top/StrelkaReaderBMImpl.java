...
public class StrelkaReaderBMImpl extends StrelkaReaderImpl {
    public StrelkaReaderBMImpl(IRfid rfid,
                               CardInfo cardInfo,
        ...
        super(rfid, cardInfo, staticKeyAuthorizationStrategy, samAuthorizationStrategy, mifareClassicReader, outerNumberReader, readPdMifareClassicReader, writePdMifareClassicReader);
    ...
    private static final String TAG = Logger.makeLogTag(StrelkaReaderBMImpl.class);
