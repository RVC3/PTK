 ...
 */
class PdV10Structure {
    // Размер ПД в байтах
    static final int PD_SIZE = 64;
    // Размер данных ПД в байтах
    static final int PD_DATA_SIZE = 60;
    // Порядковый номер
    ...
    // Даты действия
    static final int FOR_DAYS_BYTE_INDEX = 56;
    static final int FOR_DAYS_BYTE_LENGTH = 4;
    // Номер ключа ЭЦП
    static final int EDS_KEY_NUMBER_BYTE_INDEX = 60;
