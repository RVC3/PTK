...
/**
 * Ридер карт СКМО с которых не удалось прочитать ПД или ЭЦП
 * http://agile.srvdev.ru/browse/CPPKPP-34076
 *
 * @author Grigoriy Kashka
 */
public class SkmoNoPdPlaceReaderImpl extends SkmSkmoIpkReaderImpl implements SkmoNoPdPlaceReader {

    private static final byte MAX_PD_COUNT = 0;

    public SkmoNoPdPlaceReaderImpl(IRfid rfid,
                                   CardInfo cardInfo,
