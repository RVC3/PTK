...
public class CppkReaderBMImpl extends CppkReaderImpl {
    public CppkReaderBMImpl(IRfid rfid,
                            CardInfo cardInfo,
        ...
        super(rfid,
                ...
                samAuthorizationStrategy, mifareClassicReader,
                outerNumberReader,
    ...
    public ReadCardResult<List<Pd>> readPdList(){
        ...
        for(byte [] b_ticket: pdBytes) {
            Log.d("TAG", "Тариф Большая Москва " + Arrays.toString(b_ticket));
